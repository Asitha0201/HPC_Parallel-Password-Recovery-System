...
int main() {
    ...
    // Prefer V2 dictionary_old.txt as requested
    FILE *file = fopen("V2/dictionary_old.txt", "r");
    if (!file) {
        // fallback options (in case user runs from different working directory)
        file = fopen("V2/dictionary_old.txt", "r");
    }
